...
export default function AdminProductForm() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                ...
                // Safely handle if data is returned directly or wrapped in a product object
                ...
                // ✅ FIXED: Changed error.res to error.response
    ...
    const handleSubmit = async (e: React.FormEvent) => { // ✅ Standardized Type signature
        e.preventDefault();
        setSaving(true);
        try {
