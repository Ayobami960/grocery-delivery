  ...
  return (
    <div className="min-h-screen bg-app-cream mb-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Tabs */}
        <div className="flex gpa-2 mb-6 overflow-x-auto pb-2">
          {tabs.map((tab) => (
        ...
        {loading ? (
          ...
          <div className="text-center py-16">
            ...
            <h2 className="text-sm text-app-text-light mb-4">No orders yet
            </h2>
            <p className="text-sm text-app-text-light mb-4">Start shopping to
