...
const ProductPage = () => {
  ...
  return (
    <div className="min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 ;g:px-8 py-6">
        {/* Breadcrumb */}
            ...
            <div className="p-6 md:p-10 flex flex-col justify-center">
              ...
              {product.rating > 0 && (
                <div className="flex items-center gap-2 mb-5">
                  ...
                  <span className="text-sm text-app-light">
              ...
              <div className="flex items-center gap-3">
                ...
                border-app-border rounded-xl overflow-hidden">
                  ...
                  min-w-10 text-center">{displayQuantity}</span>
                  <button
                    onClick={handlePlus}
                    className="p-3 hover:bg-app-cream
                  transition-colors">
        ...
        {relatedProducts.length > 0 && (
          <section className="mt-12 mb-44">
            <div className="flex items-center justify-between mb-6">
              ...
              text-app-orange hover:text-app-orange-dark flex items-center
