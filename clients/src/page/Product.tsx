    ...
    <div className="min-h-screen bg-app-cream">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <nav className="flex items-center gap-2 text-sm text-app-text-light mb-6">
          ...
          <span>/</span>
          <span className="text-app-green font-medium">{activeCategory ? activeCategory.name : "Bakery"}</span>
        </nav>
            ...
            <div className="flex items-center justify-between mb-6">
              <div>
                <h1 className="text-2xl font-semibold text-app-green">
                  {activeCategory ? activeCategory.name : "Bakery"}
                </h1>
                <p className="text-s text-app-text-light mt-0.5">
                  {products.length}
                  products found
                </p>
              </div>
              ...
              <div className="flex flex-col lg:items-center gap-3">
                ...
                rounded-xl border border-app-border hover:bg-app-cream
                transition-colors"
                >
              ...
              <div className="flex items-center gap-2 mt-16">
                {Array.from({ length: totalPages }).map((_, i) => (
                  <button
                    ...
                    transition-colors ${page === String(i + 1) ? "bg-app-green text-white" :
      ...
      {mobileFiltersOpen && (
        <>
          ...
          max-h-[80vh] overflow-auto animate-slide-in-up">
            <div className="flex items-center justify-between p-4 border-bborder-app-border">
