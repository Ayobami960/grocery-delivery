  ...
  return (
    <div className="min-h-screen bg-app-cream">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        {/* header */}
        <div className="mb-8">
          <h1 className="text.sm text-app-text-light">
            {loading ? "Searching..." : `${products.length} item found`}
          </h1>
        </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-20">
            ...
            <p className="text-sm text-app-text-light mb-6 max-w-md mx-auto">We couldn't find any product matching "{query}". Try a different
              search term.
            </p>
            <Link to="/products"
            className="inline-flex px-5 py-2.5 bg-app-green
