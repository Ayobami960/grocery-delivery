    ...
    return (
      <div className="min-h-screen bg-app-cream flex-center">
        <div className="text-center">
          ...
          bg-app-green text-white text-sm font-medium
    ...
    <div className="min-h-screen bg-app-cream">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <button onClick={() => navigate(-1)}
          ...
          text-app-text-light hover:text-apppgreen mb-6 transition-colors"
        >
        ...
        <div className="flex items-center gap-2 mb-8">
          {steps.map((s, i) => (
            ...
            gap-2 px-4 py-2 rounded-xl text-sm font-medium transition-colors ${step === s.key ?
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-2xl p-5 h-fit sticky top-24">
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex justify-between">
                <span className="flex justify-between">Delivery</span>
