...
const CartSidebar = () => {
    ...
    shadow-2xl flex flex-col animate-slide-in-right">
        ...
        border-app-border">
                    ...
                    <button
                        onClick={() => setIsCartOpen(false)}
                        className="p-2 rouded-xl hover:bg-app-cream transition-colors"
                    >
                ...
                h-full text-center">
                    ...
                    bg-app-cream/60 rounded-xl p-3">
                            ...
                            mt-2">
                                        ...
                                        border borde-app-border flex-center"
                                            >
                ...
                {items.length > 0 && (
                    <div className="p-5 border-t border-app-border space-y-3">
                        ...
                        <div className="flex justify-between text-sm">
                            <span className="text-app-test-light">Delivery</span>
                        ...
                        rounded-xl hover:bg-app-orange-dark transition-colors
                        flex-center gap-2 active:scale-[0.98]"
                        >
                            Process to Checkout <ArrowRightIcon className="size-4"/>
                        </button>
                    </div>
                )}
            </div>
