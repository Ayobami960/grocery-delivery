...
const ProductCard = ({ product }: Props) => {
    ...
    transition-all duration-300 group animate-fade-in cursor-pointer"
            ...
            <div className="relative aspect-square overflow-hidden">
                ...
                font-semibold uppercase bg-app-orangetext-white rounded-full">
                        {product.discount}% OFF </span>}
                </div>
            </div>

            {/* Info */}
            <div className="p-3.5 text-zine-700">
                ...
                {product.rating > 0 && (
                    <div className="flex items-center gap-1 mb-2">
                        ...
                        <span className="text-xs font-medium etext-app-text">{product.rating}</span>
                ...
                <div className="flex items-center justify-between">
                    ...
                    shrink-0 hover:g-app-ornage-dark transition-colors active:scale-95"
                    >
