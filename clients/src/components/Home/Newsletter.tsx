...
const Newsletter = () => {
    return (
        <section className="bg-white py-18 px-4 sm:px-6 lg:px-8 rounded-3xl mx-autoshadow-xs mt-32 mb-20">
            <div className="max-w-2xl mx-auto text-center">
                ...
                <p text-app-text-light mb-8 text-base>Get weekly update on fresh products, seasonal offers, and exclusive discounts right to your inbox.</p>
